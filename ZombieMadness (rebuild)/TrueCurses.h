...
bool initscr(int height, int width,int color_depth,int font_scale_factor); // intilize screen
...
void mvprintwx(int y, int x,string c,int foreground_color,int background_color);
